...
##
golem::fill_desc(
  pkg_name = "ExamVision", # The Name of the package containing the App
  pkg_title = "INVARASCOPIC", # The Title of the package containing the App
  pkg_description = "An app that ExamVision may use to quickly recommend laser safety inserts to their customers.", # The Description of the package containing the App
